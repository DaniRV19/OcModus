<x-layout>
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <input type="text" name="name" id="name"
                                       ...
                                       placeholder="Categoria" value="{{ $category->name }}" required>
                            </div>
                            @error('name')
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <input type="text" name="slug" id="slug"
                                       class="block min-w-0 grow py-1.5 px-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6"
                                       placeholder="Categoria" value="{{ $category->slug }}" required>
                            </div>
                            @error('slug')
                            <p class="text-xs text-red-500 font-semibold mt-2 ms-2">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <input type="text" name="description" id="description"
                                       class="block min-w-0 grow py-1.5 px-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6"
                                       placeholder="Descripción..." value="{{ $category->description }}" required>
                            </div>
                            @error('description')
                                <p class="text-xs text-red-500 font-semibold mt-2 ms-2">{{ $message }}</p>
                            @enderror
    ...
    <form method="POST" action="/categories/{{ $category->id }}" class="hidden" id="delete-form">
        @csrf
        @method('DELETE')
    </form>
