    ...
    <div class="max-w-4xl mx-auto p-8 rounded-lg shadow bg-white/80">
        ...
        <form method="POST" action="/roles">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    <label for="name" class="block text-[#483D00] font-medium mb-2">Nombre del Rol</label>
            ...
            <div class="mt-8 flex justify-end space-x-4">
                <a href="/roles" class="px-6 py-2 border border-gray-300 rounded text-[#483D00] hover:bg-gray-100 transition duration-300 hover:cursor-pointer">
                    Cancelar
                </a>
