...
<head>
    ...
    <nav class="bg-gray-800">
        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="shrink-0">
                <img class="size-28" src="{{ asset('img/logo-primary-nobg.png') }}" alt="Oc Modus Logo">
            </div>
            ...
            <div class="ml-4 flex items-center md:ml-6">
                ...
                <div>
                    ...
                    <img class="size-14 rounded-full" src="{{ asset('img/bombona.png') }}" alt="">
                    </button>
                </div>
                </div>
            </div>
        ...
        <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
            <x-nav-link href="/" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white" aria-current="page">Inicio</x-nav-link>
            <x-nav-link href="/about" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">About</x-nav-link>
        ...
        <div class="border-t border-gray-700 pt-4 pb-3">
            ...
            <div class="shrink-0">
                <img class="size-10 rounded-full" src="{{ asset('img/bombona.png') }}" alt="">
            </div>
            <div class="ml-3">
                <div class="text-base/5 font-medium text-white">John Doe</div>
                <div class="text-sm font-medium text-gray-400">john@doe.com</div>
            </div>
