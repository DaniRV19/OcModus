...
{{--                        <img class="w-28" src="{{asset('img/logo-primary-nobg.png')}}"--}}
{{--                             alt="Oc Modus">--}}
{{--                    </div>--}}
...
{{--                            <x-nav-link href="/register" :active="request()->is('register')">Registro</x-nav-link>--}}
{{--                        @endguest--}}
...
{{--                    </div>--}}
{{--                </div>--}}
{{--                <div class="-mr-2 flex justify-baseline sm:hidden">--}}
{{--                    <!-- Mobile menu button -->--}}
{{--                    <button type="button"--}}
...
{{--                        <div class="text-sm font-medium leading-none text-gray-400">info@ocmodus.com</div>--}}
{{--                    </div>--}}
{{--                    <button type="button"--}}
