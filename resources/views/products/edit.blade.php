                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <select name="category_id" id="category_id"
                                    class="block min-w-0 grow py-1.5 px-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6" required>
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <input type="text" name="name" id="name"
                                    ...
                                    placeholder="Maceta" value={{ $product->name }} required>
                            </div>
                            @error('name')
                                <p class="text-xs text-red-500 font-semibold mt-2 ms-2">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <input type="text" name="price" id="price"
                                    class="block min-w-0 grow py-1.5 px-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6"
                                    placeholder="999€" value="{{ $product->price }}" required>
                            </div>
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <input type="text" name="description" id="description"
                                    class="block min-w-0 grow py-1.5 px-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6"
                                    placeholder="Descripción..." value={{ $product->description }} required>
                            </div>
                            @error('description')
                                <p class="text-xs text-red-500 font-semibold mt-2 ms-2">{{ $message }}</p>
                            @enderror
