                    ...
                    <div class="flex items-center space-x-4">
                        <a href="{{ route('shopping_cart.index') }}"
                            ...
                            @if(Cart::instance('cart')->content()->count() > 0)
                                <span
                                    class="absolute -top-2 -right-2 bg-primary-green text-black text-xs rounded-full h-5 w-5 flex items-center justify-center">{{ Cart::instance('cart')->content()->count() }}</span>
                            @endif
                        </a>
                    </div>
                </div>
